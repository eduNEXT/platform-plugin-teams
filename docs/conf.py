...
"""
platform-plugin-teams documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'platform-plugin-teams',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/openedx/platform-plugin-teams",
...
#
# html_title = 'platform-plugin-teams v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Open edX plugin that includes a custom teams API',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'platform_plugin_teams'),
                os.path.join(root_path, 'platform_plugin_teams/migrations')])
